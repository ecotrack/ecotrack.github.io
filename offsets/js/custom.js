...
(function($) {
    ...
    $('.mailchimp').ajaxChimp({
        ...
        url: "http://ecotrack.us14.list-manage.com/subscribe/post?u=89bf3ba48d8361e1ea148b0e2&amp;id=5c27aca6e6" //Replace this with your own mailchimp post URL. Don't remove the "". Just paste the url inside "".
    });
...
jQuery(document).ready(function($) {
    ...
    var $latitude = 42.361150, //If you unable to find latitude and longitude of your address. Please visit http://www.latlong.net/convert-address-to-lat-long.html you can easily generate.
        $longitude = -71.084846,
